...
useEffect(()=>{
    const fetchTiendas = async() => {
        const response = await fetch("https://grupo.tailoy.com.pe/trabajaconnosotros/citas/api");
    ...
    return (
        ...
        <div className="col-md-8  mt-3" >
            <div>
              En este portal podras reservar citas pra entrevistas de <strong>puestos vacantes</strong> en nuestras <strong>tiendas y almacenes</strong>.
            </div>
            <br></br>
            <div>Para puestos en otras areas da click <a href="https://grupo.tailoy.com.pe/trabajaconnosotros/">aqui</a></div>
            <br></br>
